...
document.write('<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/FLMGroup/gd-index@2.0/custom.css">');
// Markdown
...
function nav(path) {
    ...
    <a href="https://github.com/FLMGroup/gd-index" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: 'GoIndex on Github'}">
...
function list(path) {
	...
	$.post(path, '{"password":"' + password + '"}', function (data, status) {
		...
		if (typeof obj != 'null' && obj.hasOwnProperty('error') && obj.error.code == '401') {
			var pass = prompt("Masukin password dulu jon", "");
...
document.write('<script src="//cdn.jsdelivr.net/gh/FLMGroup/gd-index@2.0/cari.js"></script>');
